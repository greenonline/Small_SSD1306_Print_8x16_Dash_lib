/*
** Small_SSD1306_Print_8x16_Dash_lib extends SSD1306_OLED_HW_I2C_PRINT_8X16_DASH_LIB
...
Small_SSD1306_Print_8x16_Dash_lib::Small_SSD1306_Print_8x16_Dash_lib(void) : SSD1306_OLED_HW_I2C_PRINT_8X16_DASH_LIB()
{
...
size_t Small_SSD1306_Print_8x16_Dash_lib::write(uint8_t character) { 
...
size_t Small_SSD1306_Print_8x16_Dash_lib::write(const char *str) { 
  if (print8x16CharactersOn)
...
size_t Small_SSD1306_Print_8x16_Dash_lib::write(const uint8_t *buffer, size_t size) { 
  if (print8x16CharactersOn)
...
void Small_SSD1306_Print_8x16_Dash_lib::begin(void) {     
//  SSD1306_OLED_HW_I2C_LIB_PRINT::D_INIT();       // Initialize OLED
  D_INIT();       // Initialize OLED
}

void Small_SSD1306_Print_8x16_Dash_lib::clear(void) {     
//  SSD1306_OLED_HW_I2C_LIB_PRINT::D_CLEAR();       // clear OLED
  D_CLEAR();       // clear OLED
}

void Small_SSD1306_Print_8x16_Dash_lib::setCursor(uint8_t x, uint8_t y) { 
...
void Small_SSD1306_Print_8x16_Dash_lib::setCursorMode(boolean characterResolutionMode) {     
  characterResolutionOn = characterResolutionMode;       // set cursor mode
}

void Small_SSD1306_Print_8x16_Dash_lib::setPrint8x16CharacterMode(boolean printMode) {     
